    ...
    <main class="mdl-layout__content">
      ...
      <div class=" page-content-php">
        <div id="user-info">
          ...
          if ($age >= 17) {
            echo "<p>You can see an R rated movie since your are " . $age . ".</p>";
          } else if ($age >= 13) {
            echo "<p>You can see a PG-13 rated movie since your are " . $age . ".</p>";
          } else if ($age >= 5) {
            echo "<p>You can see a G or PG rated movie since your are " . $age . ".</p>";
          } else {
            echo "<p>You probably should not watch a movie alone since your are " . $age . ".</p>";
          }
          ?>
